...
#     'profile_feedback': 'This feedback would help people that visit your hometown!! No one knows better than a local :)',
    ...
    'close': 'to',
    'add-day': 'Add new day',
    'picture_help': 'The picture should have size 700*429 (width/height). If the size of the picture is different, the picture will be resized and cutted to fit in these dimensions.',
